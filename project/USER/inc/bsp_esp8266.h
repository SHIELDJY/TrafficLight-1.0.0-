...
#define      macESP8266_Tx_CLK                                RCC_APB2Periph_GPIOB
#define      macESP8266_Tx_PORT                               GPIOB
#define      macESP8266_Tx_PIN                                GPIO_Pin_10

#define      macESP8266_Rx_APBxClock_FUN                      RCC_APB2PeriphClockCmd
#define      macESP8266_Rx_CLK                                RCC_APB2Periph_GPIOB
#define      macESP8266_Rx_PORT                               GPIOB
#define      macESP8266_Rx_PIN                                GPIO_Pin_11
