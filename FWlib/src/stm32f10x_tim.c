...
/**
  * @brief  初始化 TIMx 时基外部设备 according to 
...
void TIM_TimeBaseInit(TIM_TypeDef* TIMx, TIM_TimeBaseInitTypeDef* TIM_TimeBaseInitStruct)
{
  ...
  /* 生成一个用于立即重载预分频器值的更新事件 */
  TIMx->EGR = TIM_PSCReloadMode_Immediate;          
}

/**
  * @brief  初始化 TIMx 通道1  according to the specified
...
/**
  * @brief  初始化 TIMx 通道2 according to the specified
  *   parameters in the TIM_OCInitStruct.
  * @param TIMx: where x can be  1, 2, 3, 4, 5 or 8 to select the TIM 
  *   peripheral.
  * @param TIM_OCInitStruct: pointer to a TIM_OCInitTypeDef structure
...
/**
  * @brief  初始化 TIMx 通道3 according to the specified
  *   parameters in the TIM_OCInitStruct.
  * @param TIMx: where x can be  1, 2, 3, 4, 5 or 8 to select the TIM 
  *   peripheral.
  * @param TIM_OCInitStruct: pointer to a TIM_OCInitTypeDef structure
...
/**
  * @brief  初始化 TIMx 通道4 according to the specified
  *   parameters in the TIM_OCInitStruct.
  * @param TIMx: where x can be  1, 2, 3, 4, 5 or 8 to select the TIM 
  *   peripheral.
  * @param TIM_OCInitStruct: pointer to a TIM_OCInitTypeDef structure
...
/**
  * @brief  初始化 TIM 外部设备 according to the specified
...
/**
  * @brief  开启或关闭 TIM peripheral 主输出.
